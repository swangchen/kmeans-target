...
# 计算裁剪区域的边界线斜率
slope_1 = (box[1, 1] - box[0, 1]) / (box[1, 0] - box[0, 0])
slope_2 = (box[2, 1] - box[1, 1]) / (box[2, 0] - box[1, 0])
slope_3 = (box[3, 1] - box[2, 1]) / (box[3, 0] - box[2, 0])
slope_4 = (box[0, 1] - box[3, 1]) / (box[0, 0] - box[3, 0])

print("Slope of Line 1:", slope_1)
print("Slope of Line 2:", slope_2)
print("Slope of Line 3:", slope_3)
print("Slope of Line 4:", slope_4)
